<template>
    <div class="group w-3/4 mx-auto mt-1 bg-gray-100 text-gray-800 dark:text-gray-100 border-b border-black/10 dark:border-gray-900/50 dark:bg-[#444654]">
                ...
                <div class="w-[30px]">
                    <div class="relative p-1 rounded-sm h-[30px] w-[30px] text-white flex items-center justify-center"
                        ...
                        <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg"
                             stroke-width="1.5" class="h-6 w-6" role="img"><title>ChatGPT</title>
            ...
            <div class="relative flex w-[calc(100%-50px)] flex-row gap-1 md:gap-3 lg:w-[calc(100%-115px)]">
                <div class="flex flex-grow flex-col gap-3">
                    <div class="min-h-[20px] flex flex-col items-start gap-4 whitespace-pre-wrap break-words">
                        <div class="markdown prose w-full break-words dark:prose-invert light"><p>{{response}}</p></div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
export default {
    name: "ChatBoxResponse",
    props:{
        response:{
            type:String,
            default:"I'm here to help! Please let me know what you'd like to discuss or any questions you have, and I'll do my best to provide the information you need."
        }
    }
}
</script>
